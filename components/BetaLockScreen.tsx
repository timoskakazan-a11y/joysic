  ...
  return (
    <div className="min-h-screen bg-background text-text flex flex-col justify-center items-center p-6 text-center">
      <div className="w-full max-w-md">
        {imageUrl ? (
          <img src={imageUrl} alt="Бета-тест" className="w-48 h-48 mx-auto mb-8 animate-breathing" />
        ) : (
          <div className="w-48 h-48 mx-auto mb-8 bg-surface rounded-2xl animate-pulse"></div>
        )}
